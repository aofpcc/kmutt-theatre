            ...
            return function (f, b, c, d) {
                ...
                (function () {
                    ...
                    function q(a) {
                        ...
                        if (n)
                            for (var d = 0; d < p; d++) m.call(a, o[d]) && b.push(o[d]);
                        return b
                    }
            ...
            return function (g, h, i, d) {
                ...
                (function () {
                    ...
                    var m = ["_selenium", "callSelenium", "_Selenium_IDE_Recorder"],
                        n = ["__webdriver_evaluate", "__selenium_evaluate", "__webdriver_script_function", "__webdriver_script_func", "__webdriver_script_fn", "__fxdriver_evaluate", "__driver_unwrapped", "__webdriver_unwrapped", "__driver_evaluate", "__selenium_unwrapped", "__fxdriver_unwrapped"];
                    ...
                    function o() {
                        ...
                        if (g.external && g.external.toString && g.external.toString().indexOf("Sequentum") !== -1) return !0;
                    ...
                    d = new b(function (b, d) {
                        ...
                        b.on("getCustomParameters", function (f) {
                            if (f == null) return {};
                            var g = d.optIns,
                                h = l(g.isOptedOut(f.id, "AutomaticSetup"), a.AUTO_CONFIG_OPT_OUT);
                            ...
                            var o = l(c.getShouldProxy(), a.SHOULD_PROXY),
                                p = r();
                            h = h | g | i | m | n | f | o | p.isHeadless | p.isSelenium | p.hasDetectionFailed;
                            return {
                                o: h
                            }
                        });
                ...
                (function () {
                    ...
                    h = function () {
                        ...
                        i(d, [{
                            ...
                            key: "_validateSend",
                            value: function (b, c) {
                                if (!b.eventName || !b.eventName.length) throw new Error("Event name not specified");
                                if (!b.pixelId || !b.pixelId.length) throw new Error("PixelId not specified");
                                b.set && o(q(p(b.set), function (b) {
                            ...
                            value: function (a) {
                                ...
                                if (a.userData && p(a.userData).length > 0 && !this.fbq.loadPlugin("identity")) {
                                    g.fbq("fire", a);
                                    return this
                                }
                                var c = this.fbq.getEventCustomParameters(this.getPixel(a.pixelId)),
                            ...
                            value: function (a, b, c) {
                                ...
                                d && (d.userData && (a.userData = d.userData), d.agent != null && d.agent !== "" ? a.set = {
                                    agent: d.agent
                            ...
                            value: function (a) {
                                ...
                                (!this.fbq.pendingConfigs || r(this.fbq.pendingConfigs, function (b) {
                                    return b === a
                                }) == !1) && y(a, this.VERSION, this.RELEASE_SEGMENT != null ? this.RELEASE_SEGMENT : "stable")
                            }
                        }, {
                            key: "configLoaded",
                            value: function (a) {
                                this.configsLoaded[a] = !0, this.locks.releaseConfig(a), this.fbq.trigger("configLoaded", a)
                            }
                        }]);
                        return d
                    }();
            ...
            return function (f, g, h, i) {
                ...
                (function () {
                    ...
                    function b() {
                        ...
                        for (var c = 0; c < b.length; c++)
                            if (b[c] && b[c].src && b[c].src.indexOf(a.CDN_BASE_URL) !== -1) return b[c];
                        return null
                    }
                    ...
                    function t(a) {
                        switch (a.type) {
                            ...
                            case "INVALID_CONSENT_ACTION":
                                c = a.action;
                                return "\"fbq('" + c + "', ...);\" is not a valid fbq('consent', ...) action. Valid actions are 'await' and 'grant'.";
                            ...
                            default:
                                w(new Error("INVALID_USER_ERROR - " + a.type + " - " + JSON.stringify(a)));
        ...
        f.ensureModuleRegistered("SignalsFBEventsMobileAppBridge", function () {
            return function (g, i, j, k) {
                ...
                (function () {
                    ...
                    function m(a) {
                        if (Object.prototype.hasOwnProperty.call(k, [0]) && Object.prototype.hasOwnProperty.call(k[a[0]], a[1])) return !0;
                        var b = g[l(a)];
                ...
                (function () {
                    ...
                    c = function c() {
                        ...
                        this._sendXHRPost = function (b, c, d) {
                            ...
                            else if (XDomainRequest != undefined) f = new XDomainRequest(), f.open("POST", c), f.onerror = g;
                            else return !1;
                            f.send(b.toFormData());
                            return !0
                        };
                        this._sendFormPOST = function (b, c, f) {
                            var j = "fb" + Math.random().toString().replace(".", ""),
                ...
                (function () {
                    ...
                    a = function () {
                        ...
                        i(a, [{
                            key: "_getOpts",
                            value: function (a) {
                                return [].concat(j(Object.prototype.hasOwnProperty.call(this._subOpts, a) ? this._subOpts[a] : []), [a])
                            }
                        }, {
                            key: "_setOpt",
                            value: function (a, b, c) {
                            ...
                            value: function (a, c) {
                                var d = this,
                                    e = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
        ...
        f.ensureModuleRegistered("SignalsParamList", function () {
            return function (f, g, j, d) {
                ...
                (function () {
                    ...
                    function c(a) {
                        if (JSON === undefined || JSON === null || !JSON.stringify) return Object.prototype.toString.call(a);
                    ...
                    var f = function () {
                        ...
                        i(e, [{
                            ...
                            value: function (b) {
                                ...
                                for (var d in b) Object.prototype.hasOwnProperty.call(b, d) && this._append(encodeURIComponent(d), b[d], a, c);
                                return this
                            }
                        }, {
                            key: "_append",
                            value: function (b, e, f, g) {
                                d(e) ? this._appendPrimitive(b, e, g) : f === a ? this._appendObject(b, e, g) : this._appendPrimitive(b, c(e), g)
                            }
                        }, {
                            key: "_translateValue",
                            value: function (a, b, c) {
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    function s() {
                        ...
                        return !b && a !== null && a !== undefined && c === "Google Inc." && d === !1 && e === !1
                    }
                ...
                (function () {
                    ...
                    function S(b) {
                        try {
                            ...
                            if (b.slice(0, 6) === "report") {
                                var e = b.slice(6);
                                e === "CustomEvent" ? (e = (c[1] || {}).event || e, c = ["trackCustom", e].concat(c.slice(1))) : c = ["track", e].concat(c.slice(1))
                            }
                            b = c.shift();
                            switch (b) {
                                case "addPixelId":
                    ...
                    function T(c) {
                        ...
                        switch (c) {
                            ...
                            case "proxy":
                                var k = f[0];
                                if (d.CONFIG.PROXY_ENDPOINT) throw new Error("proxy has already been set");
                                if (typeof k !== "string") throw new Error("endpoint value must be a string");
                            ...
                            case "autoConfig":
                                ...
                                if (typeof m !== "string") throw new Error("Invalid pixelID supplied to set autoConfig.");
                            ...
                            case "firstPartyCookies":
                                ...
                                if (typeof q === "string") R.callMethod([s, q, "FirstPartyCookies"]);
                            ...
                            case "mobileBridge":
                                var y = f[0],
                                    z = f[1];
                                if (typeof y !== "string") throw new Error("Invalid pixelID supplied to set call.");
                                if (typeof z !== "string") throw new Error("Invalid appID supplied to set call.");
                            ...
                            default:
                                var C = f[0],
                                    E = f[1];
                                if (typeof c !== "string") throw new Error("The metadata setting provided in the 'set' call is invalid.");
                                if (typeof C !== "string") throw new Error("The metadata value must be a string.");
                                if (typeof E !== "string") throw new Error("Invalid pixelID supplied to set call.");
                                fa(c, C, E);
                                break
                        }
                    }
                    ...
                    function U(a, b, c) {
                        ...
                        if (J.call(O, a)) {
                            b && B(O[a].userData) ? (O[a].userData = b, $("identity")) : F({
                    ...
                    function ga(a, b) {
                        b = b || {}, n.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), W.call(this, a, b)
                    }

                    function W(a, b) {
                        for (var c = 0, d = N.length; c < d; c++) {
                            var e = N[c];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(Q, a) && Q[a].has(e.id)) continue;
                            Z(e, a, b);
                    ...
                    function Y(b) {
                        ...
                        y(e, function (a) {
                            return y(D(a), function (b) {
                                if (d.containsKey(b)) throw new Error("Custom parameter " + b + " has already been specified.");
                                else d.append(b, a[b])
                            })
                        });
                        d.append("it", I);
                    ...
                    function $(b) {
                        if (/^[a-zA-Z]\w+$/.test(b) === !1) throw new Error("Invalid plugin name: " + b);
                        var c = ja(b);
                        if (H[c]) return !0;
                        if (ba(c)) {
                            ka(c, aa(c));
                        ...
                        b = p.CONFIG.CDN_BASE_URL + "signals/plugins/" + b + ".js?v=" + a.version;
                        if (!H[c]) {
                            G.lockPlugin(c);
                            p.loadJSFile(b);
                            return !0
                    ...
                    function ka(b, c) {
                        ...
                        J.call(c, "__fbEventsPlugin") && c.__fbEventsPlugin === 1 && (H[b] = c, H[b].plugin(a, R, u), x("pluginLoaded", b));
                        G.releasePlugin(b)
                    }
                    ...
                    function oa(a) {
                        a.instance = R, a.callMethod = S, a.loadPlugin = $, a.registerPlugin = ka, a._initHandlers = [], a._initsDone = {}, a.on = v, a.once = w, a.send = X, a.trigger = x, a.getEventCustomParameters = Y, a.addInitHandler = ma, a.getState = na, a.init = U, a.set = T
                    }
                    oa(g.fbq);
                    ia();
                    k.exports = {
