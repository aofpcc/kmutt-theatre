			...
			<div class="login-form login-form-left">
				<div class="c-row">
					...
					<div class="social_icons agileinfo">
						<ul class="top-links">
									<li><a href="/group2/home/returnticket" class="return"><i class="fa fa-undo"></i> Return Ticket</a></li>
									<li><a href="/group2/home/changeticket" class="change"><i class="fa fa-exchange-alt"></i> Change</a></li>
