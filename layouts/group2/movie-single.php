...
<body>
  ...
  <div class="modal-dialog">
	...
	<!---pop-up-box---->
					<link href="/layouts/group2/css/booking/booking/popuo-box.css" rel="stylesheet" type="text/css" media="all"/>
                ...
                <ul class="nav navbar-nav">
						...
						<li><a href="movie-single.html">Hamari Adhuri Kahani (U)</a></li>
									...
									<div class="menu-featured-movies">
										...
										<div class="col-md-2 menu-featured-movies-img">
											<a href="movie-single.html"><img src="/layouts/group2/images/booking/mf1.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="movie-single.html"><img src="/layouts/group2/images/booking/mf2.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="movie-single.html"><img src="/layouts/group2/images/booking/mf3.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="movie-single.html"><img src="/layouts/group2/images/booking/mf3.jpg" alt="" /></a>
										</div>
					...
					<h5 class="movies-page">for events page - <a href="events.html">Click here</a> </h5>
								...
								<div class="e-movie-img">
									<a href="events.html"><img src="/layouts/group2/images/booking/f2.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="events.html"><img src="/layouts/group2/images/booking/f3.jpg" alt=""></a>
								</div>
								<div class="e-buy-tickets">
									<a href="event-payment.html">BUY TICKETS</a>
								</div>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="events.html"><img src="/layouts/group2/images/booking/f4.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
									<a href="event-payment.html">BUY TICKETS</a>
								</div>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="events.html"><img src="/layouts/group2/images/booking/f1.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
									<a href="event-payment.html">BUY TICKETS</a>
								</div>
                            ...
                            <li class="w3_megamenu-content withoutdesc">
								...
								<h3 class="title">Featured Events</h3>
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="plays.html"><img src="/layouts/group2/images/booking/f2.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
									<a href="event-payment.html">BUY TICKETS</a>
								</div>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="plays.html"><img src="/layouts/group2/images/booking/f3.jpg" alt=""></a>
								</div>
								<div class="e-buy-tickets">
									<a href="event-payment.html">BUY TICKETS</a>
								</div>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="plays.html"><img src="/layouts/group2/images/booking/f4.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
									<a href="event-payment.html">BUY TICKETS</a>
								</div>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="plays.html"><img src="/layouts/group2/images/booking/f1.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
									<a href="event-payment.html">BUY TICKETS</a>
								</div>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="m-single-article">
		<div class="article-left">
			<h3>Baahubali Trailer || Prabhas, Rana Daggubati, Anushka, Tamannaah || Bahubali Trailer <span> <i class="fa fa-heart"></i> 99%</span></h3>
			...
			<div class="article-time-strip">
				<div class="article-time-strip-left">
					<p>Duration <span><i class="fa fa-clock-o"></i>2 hrs 30 mins </span>  &nbsp;&nbsp; Release Date <span><i class="fa fa-calendar"></i>Jun 10, 2015</span></p>
				</div>
				<div class="clearfix"></div>
				...
				<div class="review-info">
								...
								<p class="info"><strong>CAST</strong>: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Prabhas, Rana Daggubati, Anushka, Tamannaah.</p>
								<p class="info"><strong>DIRECTION</strong>: &nbsp;&nbsp;&nbsp;&nbsp;S.S. Rajamouli.</p>
		  ...
		  <div class="response">
						<div class="media response-info">
							<div class="media-left response-text-left">
								<a href="#">
									<img class="media-object" src="/layouts/group2/images/booking/icon1.png" alt="">
								</a>
