...
<script>
    ...
    function show(code) {
        var x = "<a href='/emp/ticket/get/"+code+"' target='_blank'>___________________________________________________________________________GET__CODE___________________________________________________________________________</a>";
        $("#select_seat").empty();
        $("#select_seat").html(x);
    }
