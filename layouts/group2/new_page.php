...
<script>
    ...
    function show(code) {
        var x = "<a href='/emp/ticket/get/"+code+"' target='_blank'>___________________________________________________________________________________________________________GET__CODE________________________________________________________________________________________________________</a>";
        $("#select_seat").empty();
        $("#select_seat").html(x);
    }
