				...
				<div class="agile-row">
					...
					<div class="login-agileits-top">
                        <form action="/emp/ticket/check_return_ticket" method="post">
                            <input type="number" class="number" name="card_no" maxlength="3" Placeholder="Card No." required/>
							<input type="text" class="text" name="return_no" Placeholder="Movie ID." required/>
					...
					<div class="social_icons agileinfo">
						<ul class="top-links">
									<li><a href="/emp/ticket/home" method="post" class="gohome"><i class="fas fa-arrow-alt-circle-left"></i> Go Back</a></li>
									<li><a href="/emp/ticket/changeticket" method="post" class="change"><i class="fas fa-exchange-alt"></i> Change</a></li>
