			...
			<div class="login-form login-form-center">
				<div class="agile-row">
					...
					<div class="social_icons agileinfo">
						<ul class="top-links">
									<li><a href="/group2/home" method="post" class="gohome"><i class="fas fa-arrow-alt-circle-left"></i> Go Back</a></li>
									<li><a href="/group2/home/changeticket" method="post" class="change"><i class="fas fa-exchange-alt"></i> Change</a></li>
