...
<script async="" src="/layouts/group2/js/selecttime/gtm.js"></script>
...
<body>
                                    ...
                                    <div class="movie-detail">
                                        ...
                                        <ul class="movie-detail-list">
                                            ...
                                            <li class="list-item"><svg viewBox="0 0 126.89 126.89" class="sf-icon clock">
                                                    ...
                                                    <circle cx="63.44" cy="63.44" r="59.44" class="cls-1"></circle>
                                                    <circle cx="63.44" cy="63.44" r="4.49" class="cls-2"></circle>
                                                    <line x1="63.44" y1="14.5" x2="63.44" y2="20.84" class="cls-3"></line>
                                                    <line x1="15" y1="63.94" x2="20.34" y2="63.94" class="cls-3"></line>
                                                    <line x1="63.44" y1="112.39" x2="63.44" y2="107.05" class="cls-3"></line>
                        ...
                        <div class="slick-initialized slick-slider"><button class="slick-prev slick-arrow slick-disabled"
                            ...
                            <div class="slick-list">
                                <div class="slick-track" style="opacity: 1; width: 5700px; transform: translate3d(0px, 0px, 0px);">
                                    ...
                                    <defs></defs>
                                    <title>next</title>
                                    <polyline class="cls-1" points="4 4 32.06 34.06 4 64.12"></polyline>
                                </svg></button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="left-section">
                                            <div class="hidden-xs">
                                                ...
                                                <p class="theater-text">Digital Cinema</p>
                                            </div>
                                            <ul class="movie-detail-list left visible-xs">
                                                <li class="list-item"><span>Digital Cinema</span>
                                    ...
                                    <div class="col-sm-10 border-section">
                                        <div class="right-section">
                                            <ul class="movie-detail-list hidden-xs">
                                                ...
                                                <li class="list-item"><span><svg viewBox="0 0 405.88 359.77" class="sf-icon sound">
                                                            <defs></defs>
                                                            <title>sound</title>
                                                            <path d="M226.08,359.77a11.5,11.5,0,0,1-6.9-2.3L112.91,277.7C107.14,274,93,264.48,93,248.58V111.87c0-14.3,10.53-23.39,19.81-29.72L219.17,2.3a11.5,11.5,0,0,1,6.9-2.3,26.53,26.53,0,0,1,26.5,26.5V333.27A26.53,26.53,0,0,1,226.08,359.77ZM228.55,24L126.4,100.7,126,101c-6.7,4.55-10,8.11-10,10.85V248.58c0,1.39,1.27,4.53,9.76,10,0.22,0.14.44,0.29,0.65,0.45l102.15,76.67a3.49,3.49,0,0,0,1-2.48V26.5A3.49,3.49,0,0,0,228.55,24Z"
                                                                class="cls-1"></path>
                                            ...
                                            <ul class="time-list">
                                                <li class="time-item"><button class="button button-showtime active">13:20</button></li>
                                                <li class="time-item"><button class="button button-showtime">16:20</button></li>
                                                <li class="time-item"><button class="button button-showtime">19:20</button></li>
                                                <li class="time-item"><button class="button button-showtime">22:20</button></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="/layouts/group2/js/selecttime/manifest.86920d2276921dc8f875.js" defer=""></script>
    <script src="/layouts/group2/js/selecttime/vendor.eb91d5bf77b2c769fcc2.js" defer=""></script>
    <script src="/layouts/group2/js/selecttime/app.baa2eadcab44e34fea36.js" defer=""></script>
