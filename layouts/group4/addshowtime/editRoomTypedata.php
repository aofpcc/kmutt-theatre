            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-lg-8 mx-auto">
                  <!-- action form -->
                  <form action="/emp/g04/roomType/edit" method="post">
                  <input type="hidden" name="id" value="<?=$this->roomdata["id"] ?>">
                    <div class="form-group">
                        <label for="typename">Room Type Name:</label>
                        <input type="text" class="form-control" id="typename" name="roomtype" value="<?=$this->roomdata["roomtype"] ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="info">Room Type Information</label>
                        <textarea class="form-control" id="info" name="info" rows="7" required><?=$this->roomdata["roomInfo"] ?></textarea>
                    </div>
