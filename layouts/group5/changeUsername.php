...
<body class="body-bg">
    ...
    <div class="container">
      ...
      <div class="row account-set-position">
        <h2 style="margin-left: 110px;">Change Username</h2>
      </div>
      <!-- line -->
      <div class="gap"></div>
      <div class="box-name-text" style="margin-left: 97px;">Current Username</div>
      <div class="gap-less" style="margin-left: 97px;">computer_science18</div>
      <div class="gap"></div>
      </br>
      <!-- change form -->
      <div class="row">
        ...
        <div class="col-sm-6">
          <form>
            <div class="form-group">
              <label class="box-name-text" for="exampleInputEmail1">New Username</label>
