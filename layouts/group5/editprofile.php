        ...
        <div class="col-sm-6">
          <form>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-m" id="exampleInputPassword1" placeholder="">
            </div>
            <!-- New Password -->
            <div class="form-group">
              <label class="box-name-text gap" for="exampleInputPassword1">Last Name</label>
              <input type="text" class="form-control form-control-m" id="exampleInputPassword1" placeholder="<?php echo($this->usr[0][2])?></a>">
            </div>
