...
<div class="container text-center">
        ...
        <button onclick = "location.href = '/group9/search'" type="button" class="btn btn-secondary btn-lg">Search Movie</button>
    
</div>

<div class="container">
  <?php echo $this->sqlResult; ?>
        <form action = "/group9/action" method="POST">
                ...
                <div class="input-group">
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="date">
                      ...
                      <div class="input-group">
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="edate">
                                <option selected>Day</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="emonth">
                                <option selected>Months</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name = "eyear">
                                <option selected>Years</option>
                                <option value="2999">2999</option>
                                <option value="2998">2998</option>
                                <option value="2997">2997</option>
