...
require_once __DIR__ . '/../config/promotion.php';
...
$promotion = new \Promotion($database, $klein);

session_start();

$klein->respond(function ($request, $response, $service, $app, $validator) use ($database, $loginperformer, $pointmanager, $promotion) {
    ...
    if ($username == 'Guest') {
        ...
        $login_menu = [
            ...
            ["name" => "History", "href" => "/customer/kmutt/ticket/ticket_history"],
